    ...
    top_buttons = {
        ...
        val = {
            button("e", "New file", "<cmd>ene <CR>"),
						...
						button("g", "Find Grep", "<cmd>Telescope live_grep<CR>"),
						button("c", "Set Theme", "<cmd>Telescope colorscheme<CR>"),
						button("ls", "Load Session", "<cmd>lua require('persistence').load()<cr>"),
						button("ll", "Load Last", "<cmd>lua require('persistence').load({ last = true })<cr>"),
						button("s", "Edit Options", "<cmd>Telescope vim_options<CR>"),
